...
class Keywords {
  ...
  @override
  String toString() => 'Keywords[name=$name, values=$values]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Keywords[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Keywords[$key]" has a null value in JSON.');
        });
        return true;
      }());
