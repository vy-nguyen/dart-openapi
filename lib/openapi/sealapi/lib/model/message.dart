...
class Message {
  ...
  @override
  String toString() => 'Message[itemId=$itemId, ownerId=$ownerId, parentId=$parentId, content=$content, regId=$regId, pubKey=$pubKey]';
  ...
  static Message? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Message(
        itemId: ItemId.fromJson(json[r'itemId'])!,
        ...
        pubKey: Text.fromJson(json[r'pubKey']),
      );
    }
    return null;
  }
